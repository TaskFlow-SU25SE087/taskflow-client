    ...
    <Card>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                No need to handle personal access tokens. OAuth provides secure, temporary access that can be revoked anytime.
              </p>
            </div>
          </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>Privacy & Control:</strong> We only request read access to your repositories. 
            You can revoke access anytime from your GitHub settings, and we never store your GitHub password.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
