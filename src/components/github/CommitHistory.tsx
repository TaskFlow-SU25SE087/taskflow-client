      ...
      <CardContent className="p-4">
        <div className="flex items-start gap-4">
          <Avatar className="h-10 w-10">
            <AvatarFallback className="bg-lavender-100 text-lavender-700">
              {initials}
            </AvatarFallback>
          </Avatar>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-gray-500">
                {format(new Date(commit.commitDate), 'MMM d, yyyy HH:mm')}
              </span>
...
export default function CommitHistory({ projectId, partId }: CommitHistoryProps) {
  ...
  const filteredCommits = filterStatus === 'all' 
    ? commits 
    : getCommitsByStatus(filterStatus);
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {getCommitsByStatus(CommitStatus.Done).length}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {getCommitsByStatus(CommitStatus.Checking).length}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {getCommitsByStatus(CommitStatus.Failed).length}
                  </p>
                </div>
              </div>
            </CardContent>
