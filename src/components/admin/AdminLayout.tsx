...
export default function AdminLayout({ children, title, description, stats }: AdminLayoutProps) {
      ...
      <div className={`flex-1 flex flex-col lg:ml-0 min-h-screen transition-all duration-300 ease-in-out`}>
        ...
        <main className='flex-1 container mx-auto px-4 sm:px-6 py-4 sm:py-6'>
          ...
          <div className='mb-6 sm:mb-8'>
            ...
            {description && <p className='mt-2 text-sm sm:text-base text-gray-600'>{description}</p>}
          </div>
