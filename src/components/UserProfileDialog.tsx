      ...
      <div className="bg-white p-6 rounded shadow-lg min-w-[320px] relative">
        ...
        {loading ? (
          ...
          <div className="text-center">
            ...
            <div className="mb-1"><b>Phone:</b> {profile.phoneNumber}</div>
            <div className="mb-1"><b>Student ID:</b> {profile.studentId}</div>
            <div className="mb-1"><b>Term Season:</b> {profile.termSeason}</div>
            <div className="mb-1"><b>Term Year:</b> {profile.termYear}</div>
            <div className="mb-1"><b>Past Terms:</b> {profile.pastTerms}</div>
          </div>
        ) : (
