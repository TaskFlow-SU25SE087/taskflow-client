...
export async function createProjectPart(projectId: string, partData: {
  name: string;
...
export async function connectRepositoryToPart(projectId: string, partId: string, repoData: {
  repoUrl: string;
  accessToken: string;
}) {
